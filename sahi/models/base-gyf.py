...
class DetectionModel:
    def __init__(
        ...
        self.input_shape = [128, 128]#added by gyf
        self.phi = 's'
        self.backbone = 'cspdarknet'
        #self.model_path = 'best_epoch_weights.pth'
        self.cuda = False #True
        self.letterbox_image =False
        self.confidence=0.5
        self.nms_iou =0.3
        self.category_mapping={'0':'ship'}
        self.class_names, self.num_classes  = get_classes('cls_classes.txt')
        self.anchors, self.num_anchors      = get_anchors('yolo_anchors_ship_in_slice.txt')#added by gyf
        ...
        self._original_predictions = None #added by gyf
        self.generate()
    ...
    def convert_original_predictions(
        ...
        """
        print("gyf:shift_amount={}".format(shift_amount))
        print("gyf:full_shape={}".format(full_shape))
