...
def get_slice_bboxes(
    ...
    print("gyf:x_overlap={}".format(x_overlap))
    print("gyf:y_overlap={}".format(y_overlap))
    ...
    print("gyf:slice_bboxes={}".format(slice_bboxes))
    return slice_bboxes
...
def slice_image(
    ...
    print("gyf:output_file_name={}".format(output_file_name))
    print("gyf:output_dir={}".format(output_dir))
