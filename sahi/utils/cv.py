...
from PIL import ImageDraw, ImageFont, Image #added by gyf
...
def visualize_object_predictions(
    ...
    text_size: float = None,
    text_th: float = None,
    bbox_base: float = None, #added by gyf
    color: tuple = None,
    hide_labels: bool = False,
    ...
    for object_prediction in object_prediction_list:
        ...
        print("gyf:object_prediction.mask={}".format(object_prediction.mask))
    ...
    for object_prediction in object_prediction_list:
        ...
        print("gyf:bbox in visualize_object_predictions={}".format(bbox))
        print("gyf:category_name={}".format(category_name))
        print("gyf:score={}".format(score))
        ...
        p1, p2 = (int(bbox[0]+bbox_base[0]), int(bbox[1]+bbox_base[1])), (int(bbox[2]+bbox_base[0]), int(bbox[3]+bbox_base[1]))#added by gyf for showing on original input
        # visualize boxes
        #print("gyf:rect_th={}".format(rect_th))
        cv2.rectangle(
            image,
            p1,
            p2,
