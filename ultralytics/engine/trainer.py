...
class BaseTrainer:
    ...
    def __init__(self, cfg=DEFAULT_CFG, overrides=None, _callbacks=None):
        ...
        """
        #print("gyf:DEFAULT_CFG={}".format(DEFAULT_CFG))#DEFAULT_CFG为默认的配置文件ultralytics/cfg下的default.yaml中的配置
        ...
        try:
            if self.args.task == 'classify':
                ...
                print("gyf:self.args.data={}".format(self.args.data)) #gyf: coco128.yaml
        ...
        self.trainset, self.testset = self.get_dataset(self.data) #gyf:获取训练、测试数据
        self.ema = None
    ...
    def train(self):
        ...
        if world_size > 1 and 'LOCAL_RANK' not in os.environ:
            ...
            #print("gyf:world_size < 1") #gyf:yes
            print("gyf:world_size={}".format(world_size))#world_size=1
