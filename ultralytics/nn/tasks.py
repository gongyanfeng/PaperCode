...
def yaml_model_load(path):
    ...
    path = Path(path)
    #print("gyf:path={}".format(path)) #yolov8n.yaml
    ...
    #print("gyf:unified_path={}".format(unified_path)) #gyf: yolov8.yaml
    yaml_file = check_yaml(unified_path, hard=False) or check_yaml(path)
    #print("gyf:yaml_file={}".format(yaml_file)) #/home/gyf/e/yolov8-sahi/yolov8/ultralytics/cfg/models/v8/yolov8.yaml
