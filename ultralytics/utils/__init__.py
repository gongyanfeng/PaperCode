...
print("gyf:os.getenv('YOLO_CONFIG_DIR')={}".format(os.getenv('YOLO_CONFIG_DIR')))#None
print("gyf:get_user_config_dir()={}".format(get_user_config_dir())) #/home/gyf/.config/Ultralytics
...
class SettingsManager(dict):
    ...
    def __init__(self, file=SETTINGS_YAML, version='0.0.4'):
        ...
        print("gyf:datasets_root={}".format(datasets_root))
        print("gyf:file={}".format(file))#/home/gyf/.config/Ultralytics/settings.yaml
        self.file = Path(file)
...
print("gyf:SETTINGS['datasets_dir']={}".format(SETTINGS['datasets_dir']))
DATASETS_DIR = Path(SETTINGS['datasets_dir'])  # global datasets directory
print("gyf:DATASETS_DIR={}".format(DATASETS_DIR))
